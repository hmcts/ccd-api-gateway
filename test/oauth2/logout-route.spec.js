...
describe('logoutRoute', () => {
  ...
  beforeEach(() => {
    ...
    config.get.withArgs('secrets.ccd-demo.ccd-api-gateway-oauth2-client-secret').returns(CLIENT_SECRET);
  ...
  it('should call IDAM OAuth 2 logout endpoint with JWT token', done => {
    ...
    expect(config.get).to.be.calledWith('secrets.ccd-demo.ccd-api-gateway-oauth2-client-secret');
