...
module "api-gateway-web" {
  ...
  app_settings = {
    ...
    PROXY_AGGREGATED = "http://ccd-data-store-api-aks-perftest.service.core-compute-perftest.internal"
    PROXY_CASE_ACTIVITY = "http://ccd-case-activity-api-${local.env_ase_url}"
    PROXY_DATA = "http://ccd-data-store-api-aks-perftest.service.core-compute-perftest.internal"
    PROXY_DEFINITION_IMPORT = "http://ccd-definition-store-api-aks-perftest.service.core-compute-perftest.internal"
